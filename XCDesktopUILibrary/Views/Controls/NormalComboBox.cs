...
namespace CatBoxDesktopUILibrary.Views.Controls
{
    public partial class NormalComboBox : ComboBox
    {
            ...
            try
            {
                if (m.Msg == 0xF || m.Msg == 0x133)
                {
                    ...
                    if (m.HWnd.ToInt32() != 0)
                    {
                        ...
                        g.DrawRectangle(new Pen(this.BackColor), new Rectangle(1, 1, this.Width - 4, this.Height - 4));//防止绘制成实心
                        penBorder.Dispose();
                    }
        ...
        private void NormalComboBox_MouseEnter(object sender, EventArgs e)
        {

        }

        private void NormalComboBox_MouseLeave(object sender, EventArgs e)
        {
            
        }

        private void NormalComboBox_MouseMove(object sender, MouseEventArgs e)
        {
